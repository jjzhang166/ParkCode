...
class CVzCtrlCmd : public CControllerCmd
{
    Q_OBJECT
public:
    explicit CVzCtrlCmd(QObject *parent = 0);
...
private:
    void ConvertCmd2Xw( CmdType eSrcCmdType, QByteArray &bXwData, QByteArray &byVzData );
